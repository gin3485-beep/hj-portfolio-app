      ...
      <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 w-full">
          ...
          <div className="flex flex-col gap-6 sm:w-1/3 shrink-0">
            ...
            {/* Skills (Desktop) */}
            <div className="hidden sm:flex flex-col glass-card p-8 flex-1">
          ...
          <div className="flex flex-col gap-6 sm:w-2/3">
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              ...
              {/* Certifications */}
              <div className="glass-card p-5 sm:p-8">
                <div className="text-sm sm:text-base text-primary tracking-widest uppercase mb-5 font-bold">자격증</div>
                <div className="flex flex-col gap-4">
                  <div className="border-b border-border pb-4">
                    <div className="font-bold text-sm sm:text-base text-foreground mb-1">컴퓨터그래픽스 운용기능사</div>
                    <div className="text-sm sm:text-base text-primary font-semibold tracking-wider">2020.09</div>
                  </div>
                  <div>
                    <div className="font-bold text-sm sm:text-base text-foreground mb-1">웹디자인 기능사</div>
                    <div className="text-sm sm:text-base text-primary font-semibold tracking-wider">2020.12</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 sm:p-8 flex-1">
              ...
              <div className="relative pl-6 border-l-[3px] border-primary/20 flex flex-col gap-8">
                ...
                <div className="relative">
                  ...
                  <div className="text-sm sm:text-base text-muted-foreground mb-2">2022.02 – 2022.12 <span className="font-light">(퇴사사유: 인수합병)</span></div>
                ...
                <div className="relative">
                  <div className="absolute -left-[31px] top-1.5 w-3 h-3 rounded-full bg-primary ring-4 ring-background"></div>
                  <div className="font-bold text-[0.95rem] sm:text-lg text-foreground mb-1">오더퀸</div>
                  <div className="text-sm sm:text-base text-muted-foreground mb-2">2022.12 – 2023.10 <span className="font-light">(퇴사사유: 인수합병)</span></div>
