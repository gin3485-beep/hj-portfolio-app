...
const printProjects = [
  {
    id: 1, icon: <img src="/images/sum_print_design01.png" className="w-full h-full object-cover" alt="문화 행사 포스터" />,
    imgUrl: '/images/print_design01.png', label: 'leaflet', title: '박람회 특가 리플릿', desc: '박람회 참가를 위한 리플릿 인쇄 디자인'
  },
