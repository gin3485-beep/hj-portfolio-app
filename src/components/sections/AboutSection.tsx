    ...
    <section id="about" className="py-20 px-4 md:px-12">
      <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 w-full">
          ...
          <div className="flex flex-col gap-6 md:w-1/3 shrink-0">
            ...
            <div className="glass-card p-5 md:p-8 flex flex-row md:flex-col items-center gap-5 md:gap-6 text-center">
              <div className="w-16 h-16 md:w-24 md:h-24 shrink-0 bg-primary/10 border border-primary/20 rounded-[10px] flex items-center justify-center text-3xl md:text-5xl ">🎨</div>
            ...
            <div className="hidden md:block glass-card p-8">
              <div className="text-sm text-primary tracking-widest uppercase mb-4 font-bold text-center">🛠 스킬</div>
            ...
            <div className="glass-card p-6 md:p-8 flex-1">
              ...
              <div className="relative pl-6 border-l-[3px] border-primary/20 flex flex-col gap-8">
                ...
                <div className="relative">
                  ...
                  <span className="inline-block px-2 py-0.5 bg-primary/10 border border-primary/20 rounded text-sm md:text-base text-primary font-semibold">약 11개월</span>
                </div>
                ...
                <div className="relative">
                  ...
                  <span className="inline-block px-2 py-0.5 bg-primary/10 border border-primary/20 rounded text-sm md:text-base text-primary font-semibold">약 10개월</span>
                </div>
                ...
                <div className="relative">
                  ...
                  <span className="inline-block px-2 py-0.5 bg-primary border border-primary/40 rounded text-sm md:text-base text-white dark:text-foreground font-semibold  ">재직중</span>
                </div>
        ...
        <div className="block md:hidden glass-card p-5">
          <div className="text-sm text-primary tracking-widest uppercase mb-4 font-bold">🛠 스킬</div>
